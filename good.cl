(* The Game of Life 
 ...
 After review, we concluded the game of life would be sufficient for checking most functions. We also ran our semantic analyzer on the other example cool programs.
 *)
